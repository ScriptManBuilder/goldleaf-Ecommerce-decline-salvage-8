...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Ecommerce & Online Businesses',
      answer: 'Merchants acquiring customers through e-commerce platforms, online stores, and digital sales channels. We specialize in recovering failed payments from online transactions and cart checkout flows.'
    },
    {
